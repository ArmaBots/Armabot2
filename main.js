...
mobile: MethodMobile, 
browser: opcion == '1' ? ['ArmaBot2', 'Edge', '20.0.04'] : methodCodeQR ? ['ArmaBot2', 'Edge', '20.0.04'] : ["Ubuntu", "Chrome", "20.0.04"],
auth: {
creds: state.creds,
...
let prekey = []
let directorio = readdirSync("./ArmaBot2")
...
const directories = ['./ArmaBot2/', './GataJadiBot/']
